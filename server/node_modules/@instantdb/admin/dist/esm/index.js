...
import { tx, lookup, getOps, i, id, txInit, version as coreVersion, InstantAPIError, setInstantWarningsEnabled, validateQuery, validateTransactions, createInstantRouteHandler, SSEConnection, InstantStream, } from '@instantdb/core';
...
class InstantAdminDatabase {
    ...
    debugQuery = async (query, opts) => {
        ...
        const body = { query, 'rules-override': opts?.rules };
        if (opts?.ip) {
